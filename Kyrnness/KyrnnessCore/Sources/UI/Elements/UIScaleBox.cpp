...
{
    UUIElement::UpdateLayout(); // Primeiro calcula posi��o pr�pria
    ...
    for (UUIElement* child : Children)
    {
        if (child)
        {
            // Aqui � o segredo: Recalcula posi��o e tamanho a cada frame a partir do BaseX/BaseY/BaseWidth/BaseHeight
...
glm::mat4 UUIScaleBox::GetWorldModel()
{
    ...
    // Depois da transforma��o de posi��o/tamanho, aplicamos a escala
