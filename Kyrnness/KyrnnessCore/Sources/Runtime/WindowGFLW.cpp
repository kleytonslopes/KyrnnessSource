...
#else
	// Obter o monitor prim�rio e seu modo de v�deo
	GLFWmonitor* primaryMonitor = glfwGetPrimaryMonitor();
	const GLFWvidmode* mode = glfwGetVideoMode(primaryMonitor);

	// Criar janela em fullscreen com a resolu��o do monitor
...
#if RELEASE
	// Atualizar as configura��es do jogo com a resolu��o real
...
void UWindowGLFW::OnMouseButton(int button, int action, int mods)
{
	if (button == GLFW_MOUSE_BUTTON_LEFT) {
		...
		// Converte coordenadas se necess�rio
